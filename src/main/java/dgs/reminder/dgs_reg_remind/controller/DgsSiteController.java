...
public class DgsSiteController {
    ...
    public String getDataFromDGS() throws InterruptedException {
        ...
        personalData.put("registrant_1_name", playerService.getName());
        personalData.put("registrant_1_division_code", playerService.getDivision());
        personalData.put("registrant_1_pdga_number", playerService.getPdgaNumber());
        personalData.put("registrant_1_email", playerService.getEmail());
        personalData.put("registrant_1_phone", playerService.getPhone());
        personalData.put("registrant_1_city", playerService.getCity());
        personalData.put("registrant_1_state", playerService.getState());
        personalData.put("registrant_1_country", playerService.getCountry());
        ...
        //email section
        driver.findElement(By.id("email")).sendKeys(playerService.getEmail());
        ...
        driver.findElement(By.id("password")).sendKeys(playerService.getPassword());
